...
public class SearchVendor {
    ...
    private List<SearchVendor.Result> result = null;
    ...
    public List<SearchVendor.Result> getResult() {
        return result;
    }

    public void setResult(List<SearchVendor.Result> result) {
        this.result = result;
    }

    public SearchVendor(boolean error, String status, String message, List<SearchVendor.Result> result) {
        this.error = error;
        this.status = status;
        this.message = message;
        this.result = result;
